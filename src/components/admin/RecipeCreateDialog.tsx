            ...
            <section className="grid gap-5 px-5 py-6 sm:px-7 lg:grid-cols-[1fr_1fr]" aria-labelledby="recipe-identity-title">
              <div className="space-y-4">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <Field label="Titre français" required><Input aria-label="Titre français" value={draft.titleFr} onChange={(event) => update("titleFr", event.target.value)} placeholder="Sauce graine au poisson" /></Field>
                  <Field label="English title" required><Input aria-label="English title" value={draft.titleEn} onChange={(event) => update("titleEn", event.target.value)} placeholder="Palm nut sauce with fish" /></Field>
                ...
                <Field label="Description française" required><Textarea aria-label="Description française" value={draft.descriptionFr} onChange={(event) => update("descriptionFr", event.target.value)} rows={3} /></Field>
                <Field label="English description" required><Textarea aria-label="English description" value={draft.descriptionEn} onChange={(event) => update("descriptionEn", event.target.value)} rows={3} /></Field>
              </div>
