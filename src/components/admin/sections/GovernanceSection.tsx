...
export default function GovernanceSection({ locale, adminEmail, adminRole }: { locale: "fr" | "en"; adminEmail: string; adminRole: string }) {
  ...
  return <div className="space-y-6">
    ...
    <SectionTabs value={tab} onChange={setTab} label={isFr ? "Espaces de gouvernance" : "Governance spaces"} items={[{ value: "audit", label: isFr ? "Journal d'activité" : "Activity log" }, { value: "workspace", label: isFr ? "Référentiels" : "Reference data" }]} />
