        ...
        <section className="flex min-h-dvh items-start justify-center px-4 pb-10 pt-20 sm:items-center sm:px-10 sm:py-16 lg:px-10 xl:px-14" data-testid="admin-auth-workspace">
          <div className="w-full max-w-md">
            ...
            <form onSubmit={submit} className="mt-6 space-y-4" aria-label={isFr ? "Formulaire de connexion professionnelle" : "Professional sign-in form"}>
              ...
              <div className="min-w-0">
                <div className="mb-1.5 flex items-center justify-between gap-3"><Label htmlFor="admin-password" className="text-xs font-bold text-charcoal">{isFr ? "Mot de passe" : "Password"}</Label><a href="/admin/reset" className="inline-flex min-h-9 items-center gap-1.5 text-[10px] font-bold text-terre hover:underline"><ReiconGlyph icon={CheckCircle} weight="Filled" className="h-3.5 w-3.5 text-burgundy" />{isFr ? "Mot de passe oublié ?" : "Forgot password?"}</a></div>
