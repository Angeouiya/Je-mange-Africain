...
export function AdminGate() {
  ...
  return (
    <main className="grid min-h-screen bg-white lg:grid-cols-[minmax(0,1.08fr)_minmax(30rem,0.72fr)]">
      <section className="jma-page-grid relative hidden overflow-hidden bg-charcoal p-14 text-white lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="max-w-xl">
          <p className="text-[10px] font-extrabold uppercase text-gold">Console d'exploitation</p>
          <h1 className="mt-5 max-w-2xl font-display text-5xl font-semibold leading-[1.08]">Piloter Je mange Africain avec précision.</h1>
          <p className="mt-5 max-w-lg text-sm leading-7 text-white/62">Catalogue, recettes, stocks, commandes et conformité réunis dans un espace strictement réservé aux équipes autorisées.</p>
        </div>
        <div className="flex items-center gap-2 text-xs text-white/52"><ShieldCheck className="h-4 w-4 text-gold" /> Accès contrôlé par rôles Supabase</div>
      </section>
      ...
      <section className="flex items-center justify-center px-5 py-10 sm:px-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <h2 className="mt-5 font-display text-3xl font-semibold text-charcoal">Connexion administration</h2>
