...
<head>
  ...
  <style>
    *{box-sizing:border-box}body{margin:0;background:#f7f3f1;color:#3F2930;font:13px Arial,sans-serif;line-height:1.5}.page{width:min(900px,100%);margin:24px auto;background:#fff;padding:42px}.brand{display:flex;align-items:center;gap:16px}.brand img{width:76px;height:76px;object-fit:contain}.brand h1{margin:0;font-size:20px;color:#8A3042}.brand p,.meta p{margin:2px 0;color:#68645e}.header{display:flex;justify-content:space-between;gap:32px;padding-bottom:24px;border-bottom:3px solid #D65A32}.meta{text-align:right}.meta strong{display:block;color:#B9472B;font-size:22px}.addresses{display:grid;grid-template-columns:1fr 1fr;gap:24px;margin:28px 0}.address{border-top:1px solid #e5d8d4;padding-top:12px}.label{margin-bottom:7px;color:#8A3042;font-size:10px;font-weight:700;text-transform:uppercase}table{width:100%;border-collapse:collapse}th{background:#8A3042;color:#fff;font-size:10px;text-transform:uppercase}th,td{padding:11px 10px;text-align:left;border-bottom:1px solid #eadedb}.item{display:flex;align-items:center;gap:10px}.item img{width:42px;height:42px;flex:0 0 42px;border-radius:6px;object-fit:cover}.item small{display:block;color:#77716a}.number{text-align:right;white-space:nowrap}.summary{width:min(360px,100%);margin:24px 0 0 auto}.summary-row{display:flex;justify-content:space-between;gap:24px;padding:6px 0}.grand-total{margin-top:7px;padding:13px 0;border-top:2px solid #8A3042;border-bottom:2px solid #8A3042;color:#B9472B;font-size:18px}.payment{margin-top:28px;padding:14px;border-left:3px solid #D65A32;background:#fff8f4}.payment strong{color:#8A3042}.payment-grid{display:grid;grid-template-columns:1fr 1fr;gap:6px 24px;margin-top:6px}.footer{margin-top:36px;padding-top:18px;border-top:1px solid #e5d8d4;color:#77716a;font-size:10px;text-align:center}@media(max-width:620px){.page{margin:0;padding:24px 18px}.header,.addresses{display:block}.meta{margin-top:22px;text-align:left}.address+.address{margin-top:20px}th:nth-child(3),td:nth-child(3){display:none}.payment-grid{grid-template-columns:1fr}}@media print{body{background:#fff}.page{margin:0;width:100%;padding:20px}}
  </style>
</head>
