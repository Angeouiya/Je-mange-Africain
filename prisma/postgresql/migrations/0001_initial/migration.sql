...
-- CreateIndex
CREATE INDEX "OrderBatchAllocation_orderId_productId_idx" ON "OrderBatchAllocation"("orderId", "productId");

-- CreateIndex
CREATE INDEX "OrderBatchAllocation_batchId_idx" ON "OrderBatchAllocation"("batchId");
...
-- CreateIndex
CREATE UNIQUE INDEX "MediaAsset_objectPath_key" ON "MediaAsset"("objectPath");
...
-- CreateIndex
CREATE UNIQUE INDEX "AdminMembership_authUserId_key" ON "AdminMembership"("authUserId");

-- CreateIndex
CREATE UNIQUE INDEX "AdminMembership_email_key" ON "AdminMembership"("email");

-- CreateIndex
CREATE INDEX "AdminMembership_role_status_idx" ON "AdminMembership"("role", "status");
...
-- AddForeignKey
ALTER TABLE "OrderBatchAllocation" ADD CONSTRAINT "OrderBatchAllocation_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
